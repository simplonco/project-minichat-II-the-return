...
* Let's users use [Markdown](https://guides.github.com/features/mastering-markdown/) For example: `It's very easy to make some words **bold** and other words *italic* with Markdown. You can even [link to Google!](http://google.com)` while be replace by `It's very easy to make some words <strong>bold</strong> and other words <em>italic</em> with Markdown. You can even <a href="http://google.com">link to Google!</a></div>`
